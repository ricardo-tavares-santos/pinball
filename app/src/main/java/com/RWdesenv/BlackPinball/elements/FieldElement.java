package com.RWdesenv.BlackPinball.elements;

import static com.RWdesenv.BlackPinball.util.MathUtils.asFloat;
...
import com.RWdesenv.BlackPinball.Ball;
import com.RWdesenv.BlackPinball.Color;
import com.RWdesenv.BlackPinball.Field;
import com.RWdesenv.BlackPinball.IDrawable;
import com.RWdesenv.BlackPinball.IFieldRenderer;
import com.RWdesenv.BlackPinball.WorldLayers;
...
public abstract class FieldElement implements IDrawable {
    ...
    public static FieldElement createFromParameters(
        ...
        if (className.indexOf('.') == -1) {
            className = "com.RWdesenv.BlackPinball.elements." + className;
        }
        try {
